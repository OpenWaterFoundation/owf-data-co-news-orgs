# owf-data-co-news-orgs #

This repository contains the [Open Water Foundation (OWF)](https://openwaterfoundation.org)
dataset files for Colorado news organizations.
The initial focus is news organizations in the Poudre Basin,
...
---------------- above folders are recommended --------------------
        ...
        owf-data-co-news-orgs/              This repository.
...
[Colorado News Organizations](https://data.openwaterfoundation.org/state/co/owf/news-orgs/) dataset links.
